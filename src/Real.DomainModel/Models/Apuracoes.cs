...
public class ApuracaoService
{
    ...
    public async Task<ApuracaoContas> ApurarContasPorCompetencia(DateOnly competencia, RegimeApuracaoEnum regimeApuracaoId)
    {
        ...
        var creditosAReceber = ApurarContasPorCompetencia(lancamentos, contas, TipoContaEnum.ContaCreditoAReceber);

        var creditosAPagar = ApurarContasPorCompetencia(lancamentos, contas, TipoContaEnum.ContaCreditoAPagar);

        var debitos = ApurarContasPorCompetencia(lancamentos, contas, TipoContaEnum.ContaDebito);
