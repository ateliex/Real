        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorPorCompetencia = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    ValorPorData = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FaClass = table.Column<string>(type: "TEXT", nullable: false),
                    FaUnicode = table.Column<string>(type: "TEXT", nullable: false),
                    BiClass = table.Column<string>(type: "TEXT", nullable: false),
                    BiUnicode = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AplicaReceita = table.Column<bool>(type: "INTEGER", nullable: false),
                    AplicaDespesa = table.Column<bool>(type: "INTEGER", nullable: false),
                    Ordem = table.Column<int>(type: "INTEGER", nullable: true),
                    Ativa = table.Column<bool>(type: "INTEGER", nullable: true),
                    IconId = table.Column<string>(type: "TEXT", nullable: true),
                    CategoriaPaiId = table.Column<string>(type: "TEXT", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Version = table.Column<byte[]>(type: "BLOB", rowVersion: true, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ordem = table.Column<int>(type: "INTEGER", nullable: true),
                    TipoFinancaId = table.Column<int>(type: "INTEGER", nullable: false),
                    CategoriaId = table.Column<string>(type: "TEXT", nullable: true),
                    TipoRecorrenciaId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nivel = table.Column<int>(type: "INTEGER", nullable: false),
                    Ordem = table.Column<int>(type: "INTEGER", nullable: true),
                    EhGrupo = table.Column<bool>(type: "INTEGER", nullable: false),
                    GrupoId = table.Column<Guid>(type: "TEXT", nullable: true),
                    EhParcelamento = table.Column<bool>(type: "INTEGER", nullable: false),
                    NumeroParcelas = table.Column<int>(type: "INTEGER", nullable: false),
                    EhParcela = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    TipoFinancaId = table.Column<int>(type: "INTEGER", nullable: true),
                    CategoriaId = table.Column<string>(type: "TEXT", nullable: true),
                    EhPrevisao = table.Column<bool>(type: "INTEGER", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Version = table.Column<byte[]>(type: "BLOB", rowVersion: true, nullable: true)
                },
                constraints: table =>
